...
import GrammarAndCollocation from "@/pages/grammar-and-collocation/GrammarAndCollocation";
import GrammarAndCollocationInner from "@/pages/grammar-collocation-inner/GrammarCollocationInner";
    ...
    <QueryProvider>
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/grammar" element={<GrammarAndCollocation />} />
