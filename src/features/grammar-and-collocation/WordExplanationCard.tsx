...
const WordExplanationCard: React.FC<WordExplanationCardProps> = ({ grammarData }) => {
  ...
  return (
    <div className="bg-white rounded-2xl p-9 max-w-4xl mx-auto shadow-sm">
      <div className="mb-8">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-4">
            <h1 className="text-4xl font-semibold text-gray-900">{grammarData?.word || "activity"}</h1>
